...
public abstract class DecisionTree {
    ...
    public static DecisionTree splitNode(int featureIndex, DecisionTree left, DecisionTree right) {
         return new Root(featureIndex, left, right);
    }
    ...
    static class Root extends DecisionTree{
        final DecisionTree left;
        final DecisionTree right;
        final int featureIndex;
        Root(int featureIndex, DecisionTree left, DecisionTree right){
            this.left = left;
            this.right = right;
        ...
        public boolean predict(boolean[] features) {
            if (features[featureIndex]) return left.predict(features);
