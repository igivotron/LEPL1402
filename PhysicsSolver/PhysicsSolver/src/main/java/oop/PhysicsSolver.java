...
public class PhysicsSolver {
    ...
    public static class Slot {
         ...
         **/
        static public final boolean areSameDoubles(double a, double b) {
        ...
        public boolean setValue(double value) {
            if (this.hasValue()) {
                if (areSameDoubles(this.getValue(), value)) {
                    return false;
                } else {
    ...
    public static class Squaring extends Relation {
        ...
        @Override
        public boolean update() {
            if(number_.hasValue){return square_.setValue(number_.getValue()* number_.getValue());}
            else if(square_.hasValue){return number_.setValue(Math.sqrt(square_.getValue()));}
			 return false;
        }
